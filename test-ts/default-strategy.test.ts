...
describe("DefaultStrategy", () => {
  ...
  describe("#activateGroup()", () => {
    it("adds a group", async () => {
      await defaultStrategyContract.connect(owner).activateGroup(groupAddresses[0], ADDRESS_ZERO, ADDRESS_ZERO);
    ...
    it("emits a GroupActivated event", async () => {
      await expect(
        defaultStrategyContract.connect(owner).activateGroup(groupAddresses[0], ADDRESS_ZERO, ADDRESS_ZERO)
      )
    ...
    describe("when group is not registered", () => {
      it("reverts when trying to add an unregistered group", async () => {
        ...
        await expect(
          defaultStrategyContract.connect(owner).activateGroup(
    ...
    describe("when group has no members", () => {
      ...
      it("reverts when trying to add a group with no members", async () => {
        await expect(
          defaultStrategyContract.connect(owner).activateGroup(noMemberedGroup.address, ADDRESS_ZERO, ADDRESS_ZERO)
    ...
    describe("when group is not elected", () => {
      it("reverts when trying to add non elected group", async () => {
        ...
        await expect(
          defaultStrategyContract.connect(owner).activateGroup(nonElectedGroup.address, ADDRESS_ZERO, ADDRESS_ZERO)
    ...
    describe("when group has low slash multiplier", () => {
      ...
      it("reverts when trying to add slashed group", async () => {
        await expect(
          defaultStrategyContract.connect(owner).activateGroup(slashedGroup.address, ADDRESS_ZERO, ADDRESS_ZERO)
    ...
    describe("when some groups are already added", () => {
      ...
      it("adds another group", async () => {
        const [head] = await defaultStrategyContract.getGroupsHead();
        await defaultStrategyContract.connect(owner).activateGroup(groupAddresses[3], ADDRESS_ZERO, head);
        const activeGroups = await getDefaultGroups(defaultStrategyContract);
      ...
      it("emits a GroupActivated event", async () => {
        const [head] = await defaultStrategyContract.getGroupsHead();
        await expect(defaultStrategyContract.connect(owner).activateGroup(groupAddresses[3], ADDRESS_ZERO, head))
          .to.emit(defaultStrategyContract, "GroupActivated")
      ...
      it("reverts when trying to add an existing group", async () => {
        const [head] = await defaultStrategyContract.getGroupsHead();
        await expect(
          defaultStrategyContract.connect(owner).activateGroup(groupAddresses[1], ADDRESS_ZERO, head)
    ...
    describe("When activating groups with preexisting celo in protocol", () => {
      ...
      it("should revert when incorrect lesser and greater", async () => {
        ...
        await expect(
          defaultStrategyContract.connect(owner).activateGroup(groupAddresses[1], ADDRESS_ZERO, groupAddresses[0])
    ...
    describe("when maxNumGroupsVotedFor have been voted for", async () => {
      ...
      it("can add another group when enabled in Election contract", async () => {
        ...
        const [head] = await defaultStrategyContract.getGroupsHead();
        await expect(
          defaultStrategyContract.connect(owner).activateGroup(additionalGroup.address, ADDRESS_ZERO, head)
        )
          .to.emit(defaultStrategyContract, "GroupActivated")
      ...
      describe("when some of the groups are currently deactivated", () => {
        ...
        it("reactivates a deactivated group", async () => {
          ...
          const [head] = await defaultStrategyContract.getGroupsHead();
          await defaultStrategyContract.connect(owner).activateGroup(groupAddresses[2], ADDRESS_ZERO, head);
          const activeGroups = await getDefaultGroups(defaultStrategyContract);
        ...
        it("emits a GroupActivated event", async () => {
          ...
          await defaultStrategyContract.connect(owner).deactivateGroup(groupAddresses[7]);
          const [head] = await defaultStrategyContract.getGroupsHead();
          await expect(defaultStrategyContract.connect(owner).activateGroup(groupAddresses[2], ADDRESS_ZERO, head))
            .to.emit(defaultStrategyContract, "GroupActivated")
    ...
    describe("When 3 active groups", () => {
      ...
      describe("when the group is voted for", () => {
        ...
        it("reverts when deprecating a non active group", async () => {
          await expect(defaultStrategyContract.connect(owner).deactivateGroup(groupAddresses[3])).revertedWith(
      ...
      describe("when the group is not voted for", () => {
        ...
        it("emits a GroupRemoved event", async () => {
          await expect(defaultStrategyContract.connect(owner).deactivateGroup(deactivatedGroup.address))
