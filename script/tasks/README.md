...
`lib/manager-tasks` and `lib/account-tasks`. Every task has a counterpart here, and the
...
| `NEW_MULTISIG_OWNER` | the owner hardcoded in `update-v2-to-v3.ts` | address, optional |
