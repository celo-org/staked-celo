...
This is the full flows of how CELO is deposited and withdrawn from the system,
...
2. Call `Account.withdraw` for each group that was scheduled to be withdrawn
   ...
   transferred to the user. For the rest of the withdrawal ammount, it will be
